...
public class TestConfig {
	...
	public static String from = "vanchautran11ece@gmail.com";
	public static String password = "tranvanchauu";
	public static String[] to = { "chau.tran@morphotech.co.uk", "phuong@mailinator.com" };
